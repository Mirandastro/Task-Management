...
//   });
  ...
  document.querySelector("#searchInput").addEventListener("input", function() {
    ...
    rows.forEach(function(row) {
      ...
      const dateUploaded = row.querySelector("td:nth-child(3)").textContent.toLowerCase();
      const lastUpdated = row.querySelector("td:nth-child(4)").textContent.toLowerCase();
      const uploadedBy = row.querySelector("td:nth-child(5)").textContent.toLowerCase();
  ...
  document.getElementById("yourFilesButton").addEventListener("click", function () {
